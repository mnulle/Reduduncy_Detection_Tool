...
#ifndef INPUTRIPPSEXTERNAL_H_
#define INPUTRIPPSEXTERNAL_H_
...
/** The RIPPS input module monitoring packets coming from the Internet
 * (external) side of the network
 */
class InputRIPPSExternal : public IOModule {
	public:
		InputRIPPSExternal ();
		~InputRIPPSExternal ();
