 ...
 * 
 **********************************************************
 * $Revision: 1.2 $  $Date: 2008/02/25 21:45:52 $
 **********************************************************
 */
...
DelayLinkModule::DelayLinkModule () : IOModule () {

}


DelayLinkModule::~DelayLinkModule () {
	
}

char DelayLinkModule::initialize () {
...
bool DelayLinkModule::startModule () {
...
char DelayLinkModule::processPacket (Packet * pPacket) {
...
bool	DelayLinkModule::extractExtendedDOM (NodeDOM * pNode) {
	int			j;
	NodeDOM	*	pChild;
...
NodeDOM * DelayLinkModule::getStats () {
	return NULL;
}
