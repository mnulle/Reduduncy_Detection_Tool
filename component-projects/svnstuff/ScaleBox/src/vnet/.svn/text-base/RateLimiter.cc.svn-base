...
RateLimiterModule::RateLimiterModule () : IOModule () {
...
char RateLimiterModule::initialize () {
...
bool RateLimiterModule::startModule () {
...
char RateLimiterModule::processPacket (Packet * pPacket) {
...
bool	RateLimiterModule::extractExtendedDOM (NodeDOM * pNode) {
	int			j;
	NodeDOM	*	pChild;
...
NodeDOM * RateLimiterModule::getStats () {
	return NULL;
}
