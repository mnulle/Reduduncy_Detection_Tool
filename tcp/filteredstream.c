...
* Author: Martin Casado (Edited by Matt Nulle)
* Last Modified:2014-Jun-11
*
* Description: 
*
...
*
* Compile with:
* gcc -Wall -pedantic p2.c -lpcap (-o foo_err_something) 
*
* Usage:
        ...
        packet)
{
	...
	case IPPROTO_UDP:
	    ...
	    break;
	default:
	    fprintf(stdout,"This is not tcp or udp\n\n");
	    break;
	}
    }
        ...
        packet)
{
    ...
    fprintf(stdout,"(");
    fprintf(stdout,get_ethertype(ether_type));
    fprintf(stdout,")");
